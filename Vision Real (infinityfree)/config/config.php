...
// IA / Hugging Face con fallback inteligente (Router -> Ollama local)
define('AI_REPORT_ENABLED', true);
define('AI_REPORT_PROVIDER', 'remote'); // 'remote' = Hugging Face primero, con fallback automático a Ollama

// API remota (Hugging Face) - gratis o con token para mejor cuota
define('AI_REMOTE_ENDPOINT', 'https://router.huggingface.co/v1');
define('AI_REMOTE_TOKEN', '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');
// Modelo remoto: puedes cambiarlo por otro modelo instruct/chat de Hugging Face
define('AI_REMOTE_MODEL', 'openai/gpt-oss-20b');

// Ollama local (solo se usa si Hugging Face falla)
...
// Fallback y caché
define('AI_ENABLE_FALLBACK', APP_ENV === 'local');
