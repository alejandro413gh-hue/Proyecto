...
- Botón en el dashboard: `Generar análisis con IA`
- Motor local: `Ollama` con el modelo `gemma4:latest`
- Endpoint local: `http://localhost:11434/api/generate`
- Para InfinityFree: configura `AI_REPORT_PROVIDER=remote` y apunta `AI_REMOTE_ENDPOINT` a un gateway HTTPS que tenga acceso a Ollama


## Base de datos incluida

- Dump completo: `if0_41735490_vision_real.sql`
- Para XAMPP, impórtalo en una base llamada `vision_real` o ajusta `DB_NAME` en `config/database.php`
