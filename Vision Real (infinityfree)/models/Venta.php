...
class Venta {
    ...
    public function create($cliente_id, $usuario_id, $productos, $notas = '', $promocion_id = null, $descuento = 0, $total_sin_descuento = 0, $descuento_id = null, $descuento_aplicado = null, $tipo_venta = 'fisica', $estado = 'completada') {
        ...
        try {
            ...
            $s = $conn->prepare(
                "INSERT INTO ventas (cliente_id, usuario_id, promocion_id, descuento, descuento_id, descuento_aplicado, total, notas, total_sin_descuento, tipo_venta, estado)
                 VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)"
            );
