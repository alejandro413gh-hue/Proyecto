...
class Descuento {
    ...
    public function create($d) {
        ...
        $s->bind_param("sssdiisiss",$d['nombre'],$d['descripcion'],$d['tipo_descuento'],$d['valor'],$d['aplica_categoria_id'],$d['aplica_producto_id'],$d['aplica_genero'],$d['compras_minimas'],$d['fecha_inicio'],$d['fecha_fin']);
        return $s->execute();
    }
    ...
    public function update($id,$d) {
        ...
        $s->bind_param("sssdiisissii",$d['nombre'],$d['descripcion'],$d['tipo_descuento'],$d['valor'],$d['aplica_categoria_id'],$d['aplica_producto_id'],$d['aplica_genero'],$d['compras_minimas'],$d['fecha_inicio'],$d['fecha_fin'],$d['activo'],$id);
        return $s->execute();
    }
    ...
    public function calcularMejor($items, $cliente_id=null, $genero='todos') {
        ...
        while($d=$r->fetch_assoc()) {
            ...
            // Género
            if ($d['aplica_genero'] !== 'todos' && $genero !== $d['aplica_genero']) continue;
