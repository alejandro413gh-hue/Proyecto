...
class Talla {
    ...
    public function guardar($producto_id, $talla, $stock) {
        ...
        // Si la talla ya existe → REEMPLAZA el stock con el valor indicado
    ...
    public function getInventarioCompleto() {
        $r = $this->db->query(
            "SELECT p.id, p.codigo, p.nombre, p.precio, p.stock as stock_general, p.categoria_id,
