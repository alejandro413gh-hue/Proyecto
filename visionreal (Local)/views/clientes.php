...
<div class="main">
  ...
  <div class="content">
    ...
    <div style="background:rgba(39,174,96,0.08);border:1px solid rgba(39,174,96,0.25);border-radius:10px;padding:14px;margin-bottom:20px;font-size:.82rem;color:var(--success);display:flex;gap:12px">
      ...
      <div>
        <strong style="color:var(--white);display:block;margin-bottom:4px">📌 Clientes desde MySQL</strong>
        <span style="color:var(--white-muted)">Este módulo lee la base de clientes directamente desde MySQL para consultar, editar información y ver historial de compras.</span>
      </div>
    </div>
    ...
    <div class="card">
      <div class="card-header" style="display:flex;align-items:center;justify-content:space-between;gap:12px;flex-wrap:wrap">
        ...
        <div style="display:flex;align-items:center;gap:8px;flex-wrap:wrap">
          <a href="<?= BASE_URL ?>/views/clientes_export.php" class="btn btn-outline btn-sm">⬇️ Exportar Excel</a>
      ...
      <div class="table-wrap">
        <table id="tbl">
           <thead>
             <tr><th>Cliente</th><th>Sexo</th><th>NIT/CC</th><th>Teléfono</th><th>Email</th><th>Compras</th><th>Última Compra</th><th>Total Gastado</th><th>Acciones</th></tr>
           </thead>
          <tbody>
            ...
            <tr>
              ...
              <td><?=$c['sexo']==='M'?'👨 Masc':($c['sexo']==='F'?'👩 Fem':'🧑 Otro')?></td>
              ...
              <td>
                ...
                <span style="display:none" class="d-sexo"><?=$c['sexo']?></span>
...
function abrirEditar(btn) {
  ...
  document.getElementById('f-sexo').value     = td.querySelector('.d-sexo').textContent.trim();
